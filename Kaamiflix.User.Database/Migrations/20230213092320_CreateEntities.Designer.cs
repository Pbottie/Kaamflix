...
namespace Kaamiflix.Membership.Database.Migrations
{
    ...
    [Migration("20230213092320_CreateEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kaamiflix.Membership.Database.Entities.FilmGenre", b =>
                {
                    b.HasOne("Kaamiflix.Membership.Database.Entities.Film", null)
                        .WithMany()
                        .HasForeignKey("FilmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kaamiflix.Membership.Database.Entities.Genre", null)
                        .WithMany()
